<template>
  <div>
    ...
    <div class="bg-white rounded-b-md p-4">
        ...
        <div class="grid grid-cols-2 gap-8">
          <div>
            ...
            <div class="mt-3">
              ...
              <div class="text-xl border-b-2">
                <div v-if="detail.status_pegawai">
                  {{ detail.status_pegawai }}
                </div>
                <div v-else>
                  -
                </div>
          ...
          <div>
            ...
            <div class="mt-3">
              <label for="nip" class="font-bold">NUPTK</label>
              <div class="text-xl border-b-2">
                <div v-if="detail.nuptk">
                  {{ detail.nuptk }}
                </div>
                <div v-else>
                  -
            ...
            <div class="mt-3">
              <label for="nip" class="font-bold">JABATAN</label>
              <div class="text-xl border-b-2">
                <div v-if="detail.jabatan">
                  {{ detail.jabatan }}
                </div>
                <div v-else>
                  -
      ...
      <div v-show="activeTab == 1 && detail.jabatan == 'guru'">
        TABS 2
      </div>
...
export default {
  ...
  methods: {
    ...
    back() {
      if (this.detail.jabatan === "guru") {
        this.$router.push({ name: "ListGuru" });
      } else if (this.detail.jabatan === "staff") {
        this.$router.push({ name: "ListStaff" });
      }
    },
    getDetail(id) {
      axios
        .get("/api/profil/pegawai/" + id)
        .then(response => {
